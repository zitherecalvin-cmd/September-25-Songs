...
(function (root, factory) {
  ...
  var SONGS = [
...

    {
      ...
      key: "D",
      note: "Simplified acoustic arrangement (ver. 2 source sheet, marked beginner difficulty). The sheet is written as capo 2nd-fret shapes (C/G/D/F) — chords shown here are the real sounding pitches, transposed up 2 semitones from those shapes so no capo is needed.",
      sections: [
        { label: "Intro", lines: [
