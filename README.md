...
- **`chord_guide_set_2_sep_25.html`** / **`chord-guide-set-2-sep-25.md`** — "SET 2 SEP 25", a second 9-song setlist (see `songs-data-set-2-sep-25.js` for the source data)
...
- SET 2 SEP 25: Till They Take My Heart Away is the exception — its source .docx lives in this repo, at `September 25 Chords/files/Till_They_Take_My_Heart_Away_Chords_by_Clair_Marlo.docx`.
