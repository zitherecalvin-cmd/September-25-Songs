...
> 10 songs · designed to match the transpose-toolbar experience in `chord-guide-september.md` (see `chord_guide_september_25.html`)
> Source chords: `September 25 Chords/` folder (Ultimate-Guitar-style chord sheets); the Madonna Medley is arranged from `files/MADONNA MEDLEY.docx`, cross-checked against the three individual Madonna sheets in that folder

---

## About — Key Transposition

`chord_guide_september_25.html` adds a per-song **Key** toolbar (below each song title), same as the other guides:
...
6. [Dahil Mahal Kita](#6-dahil-mahal-kita) — The Boyfriends · Key of A
7. [Tuloy Pa Rin](#7-tuloy-pa-rin) — Neocolours · Key of G
8. [Pangako](#8-pangako) — Cueshé · Key of F
9. [Makita Kang Muli](#9-makita-kang-muli) — Sugarfree · Key of G
10. [Ang Huling El Bimbo](#10-ang-huling-el-bimbo) — Eraserheads · ♩ 90 BPM · Key of G

---

## 1. Madonna Medley — Madonna
*Like a Prayer / Like a Virgin / Material Girl*
Key of **F**

> Three-song medley performed as one continuous arrangement; transposing shifts every section together, preserving the medley's built-in key changes (F -> C for Material Girl).
...
> Modulates up a whole step (D -> E) for the final chorus and outro — written into the chart, not something the transpose toolbar does automatically.
...
## 6. Dahil Mahal Kita — The Boyfriends
Key of **A**
