# SET 2 SEP 25 — Chord Guide

> 10 songs · designed to match the transpose-toolbar experience in the other guides in this project (see `chord_guide_set_2_sep_25.html`)
> Source chords: `September 25 Chords/` folder in the Busking-September project (`D:\PERSONAL\Personal Projects\SEPTEMBER\September 25 Chords\`), Ultimate-Guitar-style chord sheets — the Freestyle Medley is arranged from `Opm_Medley_Chords_by_Freestyle_Philippines.docx`

---

## About — Key Transposition

`chord_guide_set_2_sep_25.html` adds a per-song **Key** toolbar (below each song title), same as the other guides:
...
1. [Freestyle Medley](#1-freestyle-medley) — Freestyle · When I Met You / Bakit Ba Ganyan / Think I'm Inlove · Key of Bb
2. [You Are My Religion](#2-you-are-my-religion) — FireHouse · Key of C#
3. [This Love](#3-this-love) — Maroon 5 · ♩ 95 BPM · Key of G
4. [Tadhana](#4-tadhana) — Up Dharma Down · Key of G
5. [Kung Payagan](#5-kung-payagan) — Cup of Joe · Key of C
6. [Tatlong Oras](#6-tatlong-oras) — Unknown · Key of B
7. [Maling Akala](#7-maling-akala) — Brownman Revival · Key of C
8. [Tatsulok](#8-tatsulok) — Bamboo · Key of B
9. [Awit ng Kabataan](#9-awit-ng-kabataan) — Rivermaya · ♩ 133 BPM · Key of C
10. [Gi Kumot-Kumot](#10-gi-kumot-kumot) — The Ambassadors · Key of A

---

## 1. Freestyle Medley — Freestyle
*When I Met You / Bakit Ba Ganyan / Think I'm Inlove*
Key of **Bb**

> Three-song medley performed as one continuous arrangement, capo 1st fret per the source sheet (chords below are written/fretted shapes, not sounding pitch). Transposing shifts every section together, preserving the medley's built-in key changes (Bb -> F for Bakit Ba Ganyan -> C for Think I'm Inlove, then back toward Bb for the closing reprise).

**[When I Met You — Intro]**
...
**[Bakit Ba Ganyan — Intro]**

```
F Cm F Cm
```

**[Bakit Ba Ganyan — Verse 1]**
...
**[Think I'm Inlove — Intro]**

```
Fm A# C F A# G
```

**[Think I'm Inlove — Verse 1]**
...
> The source sheet has no section labels ([Verse]/[Chorus]) — the Verse/Pre-Chorus/Chorus/Instrumental breakdown below is inferred from the repeating chord/lyric pattern.
...
> Written in B minor per the source sheet; "key" is set to "B" (the root pitch class) so the on-screen key label keeps updating correctly as you transpose.
